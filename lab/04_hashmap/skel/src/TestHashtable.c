...
main()
{
	...
	struct InfoPrieten informatii_prieteni[8];
	...
	strcpy(informatii_prieteni[4].nume, "El");
	informatii_prieteni[4].varsta = 21;
	strcpy(informatii_prieteni[4].facultate, "ACS");
	strcpy(informatii_prieteni[4].mancare_preferata, "pizza");

	strcpy(informatii_prieteni[5].nume, "Mucho");
	informatii_prieteni[5].varsta = 21;
	strcpy(informatii_prieteni[5].facultate, "ACS");
	strcpy(informatii_prieteni[5].mancare_preferata, "pizza");

	strcpy(informatii_prieteni[6].nume, "Gusto");
	informatii_prieteni[6].varsta = 21;
	strcpy(informatii_prieteni[6].facultate, "ACS");
	strcpy(informatii_prieteni[6].mancare_preferata, "pizza");

	strcpy(informatii_prieteni[7].nume, "Azteca");
	informatii_prieteni[7].varsta = 21;
	strcpy(informatii_prieteni[7].facultate, "ACS");
	...
	ht_put(ht_prieteni, "El", strlen("El") + 1, &informatii_prieteni[4],
		sizeof(informatii_prieteni[4]));
	ht_put(ht_prieteni, "Mucho", strlen("Mucho") + 1, &informatii_prieteni[5],
		sizeof(informatii_prieteni[5]));
	ht_put(ht_prieteni, "Gusto", strlen("Gusto") + 1, &informatii_prieteni[6],
		sizeof(informatii_prieteni[6]));
	ht_put(ht_prieteni, "Azteca", strlen("Azteca") + 1, &informatii_prieteni[7],
		sizeof(informatii_prieteni[7]));

	p_infoPrieten = ht_get(ht_prieteni, "Mucho");
	print_prieten(p_infoPrieten);
